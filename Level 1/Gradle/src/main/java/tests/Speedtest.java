 ...
 * javac -d classes src/name/fraser/neil/plaintext/dfmhph.diff_match_patch.java Speedtest.java
 * Execute with:
...
public class Speedtest {
  ...
  public static void main(String args[]) throws IOException {
    String text1 = readFile("D:/Speedtest1.txt");
    String text2 = readFile("D:/Speedtest2.txt");
