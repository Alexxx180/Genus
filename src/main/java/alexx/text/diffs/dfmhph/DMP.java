package alexx.text.diffs.dfmhph;
...
public class DMP {
  ...
  // Defaults.
  // Set these on your alexx.text.diffs.dfmhph.diff_match_patch instance to override the defaults.
  ...
  public int match_main(String text, String pattern, int loc) {
    ...
    if (text.equals(pattern)) {
      ...
      // Do a fuzzy alexx.text.diffs.compare.
  ...
  public static class Diff {
     ...
     * @param obj Another Diff to alexx.text.diffs.compare against.
